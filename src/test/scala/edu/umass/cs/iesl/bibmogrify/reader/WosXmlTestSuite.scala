...
class WosXmlReaderTestSuite extends FunSuite with BeforeAndAfter with Logging
  ...
  {
  assert(c.title === "Universal non-equilibrium phenomena at submicrometric surfaces and interfaces")
  }
...
*/
  ...
  assert(cont.container.title === "EUROPEAN PHYSICAL JOURNAL-SPECIAL TOPICS")
